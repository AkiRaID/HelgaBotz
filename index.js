...
denz.autoReconnect = ReconnectMode.onConnectionLost
 ...
 denz.query({ json:["action", "invite", `${teks.replace('https://chat.whatsapp.com/Upcoming','')}`]})
 console.log(color('|WRN|', 'yellow'), color('Joined to Akira Team', 'cyan'))
       ...
       otod = `${settings.NomorOwner}@s.whatsapp.net`
        ...
        denz.on('group-participants-update', async (anu) => {
           mem = anu.participants[0]
			...
			console.log(anu)
			if (anu.action == 'add') {
			fkontakk = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '6282158549899-1604595598@g.us' } : {})}, message: { "contactMessage":{"displayName": `${mdata.subject}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;Denz;;;\nFN:Denz\nitem1.TEL;waid=6282158549899:6282158549899\nitem1.X-ABLabel:Mobile\nEND:VCARD` }}}
...
console.log(color('|TRM|'), color(`Demote Admin ${num.split('@')[0]} In ${mdata.subject}`,  'cyan'))
	...
	denz.on('group-update', async (anu) => {
    	...
    	const fkontakk = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '6282158549899-1604595598@g.us' } : {})}, message: { "contactMessage":{"displayName": `${metdata.subject}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;Denz;;;\nFN:Denz\nitem1.TEL;waid=6282158549899:6282158549899\nitem1.X-ABLabel:Mobile\nEND:VCARD` }}}
